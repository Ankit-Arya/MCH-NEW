...
def _workflow_tracker(db: Session, inspection: Inspection) -> dict:
    ...
    stages = [
        ...
        _stage(
            ...
            submitter_name,
            note="Submitted for approval" if inspection.submitted_at else "Not submitted yet",
        ),
        _stage(
            "line_manager",
            ...
            lm_review.comments if lm_review else None,
        ),
        _stage(
            "dgm",
            "DGM decision",
            ...
            dgm_review.comments if dgm_review else None,
        ),
        _stage(
            "gm",
            "GM/Ops review",
            ...
            gm_review.comments if gm_review else None,
        ),
    ]
